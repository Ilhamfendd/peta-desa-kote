...
const KATEGORI = {
  ...
  olahraga:      { label: 'Olahraga',           warna: '--pin-olahraga',
                   ikon: 'M3.6 6.2h16.8v11.6H3.6zM12 6.2v11.6M12 9.4a2.6 2.6 0 1 0 0 5.2 2.6 2.6 0 0 0 0-5.2z' },
  pemakaman:     { label: 'Pemakaman',          warna: '--pin-pemakaman',
                   ikon: 'M4.5 20.4h15M9.4 20.4V9.6a2.6 2.6 0 0 1 5.2 0v10.8M10.6 12.6h2.8' },
  ...
  keamanan:      { label: 'Keamanan',           warna: '--pin-keamanan',
                   ikon: 'M12 3.6l7 2.6v5.2c0 4.2-2.9 7.6-7 9-4.1-1.4-7-4.8-7-9V6.2z' },
  kebencanaan:   { label: 'Kebencanaan',        warna: '--pin-kebencanaan',
                   ikon: 'M10.3 4.2L2.6 17.5a2 2 0 0 0 1.7 3h15.4a2 2 0 0 0 1.7-3L13.7 4.2a2 2 0 0 0-3.4 0zM12 9.4v4.2M12 17h.01' },
